...
module.exports.WG_NAME = process.env.WG_NAME || 'wg0';
...
iptables -A FORWARD -i ${module.exports.WG_NAME} -j ACCEPT;
iptables -A FORWARD -o ${module.exports.WG_NAME} -j ACCEPT;
`.split('\n').join(' ');
